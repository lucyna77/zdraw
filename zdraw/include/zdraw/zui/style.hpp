...
namespace zui {
	...
	struct style
	{
		...
		zdraw::rgba checkbox_check{ 139, 159, 223, 255 };

		zdraw::rgba slider_bg{ 32, 32, 32, 255 };
		zdraw::rgba slider_border{ 60, 60, 60, 255 };
		zdraw::rgba slider_fill{ 139, 159, 223, 255 };
		zdraw::rgba slider_grab{ 139, 159, 223, 255 };
		zdraw::rgba slider_grab_active{ 159, 179, 243, 255 };
		...
		zdraw::rgba keybind_waiting{ 139, 159, 223, 255 };
		...
		zdraw::rgba combo_item_selected{ 139, 159, 223, 40 };
		...
		zdraw::rgba scrollbar_thumb_active{ 139, 159, 223, 255 };

		zdraw::rgba text{ 225, 225, 225, 255 };
		zdraw::rgba accent{ 139, 159, 223, 255 };
	};
